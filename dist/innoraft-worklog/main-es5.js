...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.deleteLog = function (id) {
        var index = this.logs.findIndex(function (e) { return e.id == id; });
        this.logs.splice(index, 1);
    };
    AppComponent.prototype.generateLog = function () {
        this.showLogs = true;
        this.logsDisplay = [];
        this.logsDisplay = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.logs);
        this.totalHours = 0;
...
var LogViewComponent = /** @class */ (function () {
    ...
    LogViewComponent.prototype.copyTable = function () {
        console.log('Copying');
